...
Sequencing data is processed using a custom pipeline I developed that runs on a high-performance computing cluster. The source code is provided on the attached storage media and can also be found online\footnote{http://dalai.mshri.on.ca/$\sim$jweile/projects/kiloseq/}.
