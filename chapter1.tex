...
\paragraph{POPCode}
POPCode oligos are generated using the POPCodeSuite webtool which uses the following algorithm: \todo{provide algorithm?}
...
\paragraph{Library construction}
\todo{en-masse LR, automated colony picking}
