...
DMS-TileSeq was performed for \gene{SUMO1}, \gene{TPK1}, \gene{NCS1}, and \gene{CALM1} as described in chapter~\cite{ch:data1}.
...
%Alignment extraction yeast, amoeba, fly
%Blind scoring of sumoylation assays
%phydms

\subsection{Intragenic epistasis analysis}
